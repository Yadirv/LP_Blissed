...
window.ComponentLoader.registerComponent("blog-post", (root) => {
  ...
  codeBlocks.forEach((block) => {
    ...
    button.className =
      "absolute top-2 right-2 px-3 py-1 text-sm bg-blissed-olive text-white rounded hover:bg-blissed-gray transition-colors";
  ...
  progressBar.className =
    "fixed top-0 left-0 h-1 bg-gradient-to-r from-blissed-purple-start to-blissed-purple-end z-50 transition-all duration-150";
